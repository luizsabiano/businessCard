...
import br.com.luizsabiano.businesscard.databinding.ItemBusinessCardBinding
...
class BusinessCardAdapter: ListAdapter<BusinessCard, BusinessCardAdapter.ViewHolder>(DiffCallback()){
    ...
    inner class ViewHolder(
        ...
        fun bind(item : BusinessCard){
            ...
            binding.mcvContent.setCardBackgroundColor(Color.parseColor(item.personalBackground))
